...
(def mathbox-taylor-viewer
  {:transform-fn clerk/mark-presented
   :render-fn '(fn [{:keys [title]}]
                 (reagent.core/with-let [!order (reagent.core/atom 6)
...
(def mathbox-double-pendulum-viewer
  {:transform-fn clerk/mark-presented
   :render-fn '(fn [{:keys [title]}]
                 (reagent.core/with-let [!mathbox (reagent.core/atom nil)
...
(def mathbox-knot-viewer
  {:transform-fn clerk/mark-presented
   :render-fn '(fn [{:keys [title]}]
                 (reagent.core/with-let [!p (reagent.core/atom 2)
...
(def mathbox-well-viewer
  {:transform-fn clerk/mark-presented
   :render-fn '(fn [{:keys [title]}]
                 (reagent.core/with-let [!k (reagent.core/atom 1.0)
...
(def mathbox-torus-geodesic-viewer
  {:transform-fn clerk/mark-presented
   :render-fn '(fn [{:keys [title]}]
                 (reagent.core/with-let [!R (reagent.core/atom 1.8)
